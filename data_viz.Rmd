...
For trans students, somewhat agree is also the highest category (about 28%), but agree, disagree, and somewhat disagree are all very close together (between 17% and 18%). Finally, strongly disagree (5%) is much higher than strongly agree (12%).
